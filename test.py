...
def eval(net, c, dataloader, device):
    ...
    with torch.no_grad():
        ...
        print('Min Distance_test: {:.3f}'.format(min_distance))
        print('Avg Distance_test: {:.3f}'.format(avg_distance))
        print('Max Distance_test: {:.3f}'.format(max_distance))
    ...
    # Plot center and boundaries based on t-SNE coordinates
    plt.scatter(center_2d[0].item(), center_2d[1].item(), color='green', marker='x', label='Center', s=5)
